...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const resultPayload = {
      ...
      revo_scores: resultState.revoScores,
      top_type_keys: resultState.topTypes.map((type) => type.key),
      top_revo_type_keys: resultState.topRevoTypeKeys,
      main_type_key: resultState.mainType.key,
      main_type_name: resultState.mainType.name,
      main_revo_type_key: resultState.mainType.revoTypeKey,
      main_original_role: resultState.mainType.originalRole,
      sub_type_key: resultState.subType.key,
      sub_type_name: resultState.subType.name,
      sub_revo_type_key: resultState.subType.revoTypeKey,
      sub_original_role: resultState.subType.originalRole,
      support_type_key: resultState.supportType.key,
      support_type_name: resultState.supportType.name,
      support_revo_type_key: resultState.supportType.revoTypeKey,
      support_original_role: resultState.supportType.originalRole,
      ...
      partner_revo_type_key: resultState.partnerType.revoTypeKey,
      partner_original_role: resultState.partnerType.originalRole,

...
export const questions: Question[] = [
  ...
  },
  {
    ...
    scores: {},
    choices: [
      { value: 1, label: "小さく始めれば空気が変わりそう", scores: { revolist: 3, crazist: 1 } },
      { value: 2, label: "誰かと一緒なら始められそう", scores: { communicator: 2, movmentor: 2 } },
      { value: 3, label: "必要な理由を先に整理したい", scores: { logicalmaister: 2, inforader: 2 } },
      { value: 4, label: "もっと面白い形にしてから始めたい", scores: { maxdesigner: 3, imagemaister: 1 } },
      { value: 5, label: "続けられる体制が見えてから動きたい", scores: { premiercrafter: 2, arranger: 2 } },
    ],
  },
  {
    id: 23,
    ...
    scores: {},
    choices: [
      { value: 1, label: "誰がどの役割を持つと動きやすいか", scores: { arranger: 3, communicator: 1 } },
      { value: 2, label: "抜けている役割や情報がないか", scores: { arranger: 2, inforader: 2 } },
      { value: 3, label: "まず動き出す人がいるか", scores: { revolist: 2, movmentor: 1 } },
      { value: 4, label: "安心して参加できる状態か", scores: { soulowner: 3, communicator: 1 } },
      { value: 5, label: "もっと面白い組み合わせがないか", scores: { maxdesigner: 2, crazist: 2 } },
    ],
  },
  {
    id: 24,
    ...
    scores: {},
    choices: [
      { value: 1, label: "今は言わずに、もう少し自分の中で確かめる", scores: { crazist: 2, inforader: 1 } },
      { value: 2, label: "場に投げて、反応を見てみる", scores: { crazist: 3, revolist: 1 } },
      { value: 3, label: "未来の選択肢として広げてみる", scores: { maxdesigner: 3, revolist: 1 } },
      { value: 4, label: "伝わる形にしてから共有する", scores: { logicalmaister: 2, imagemaister: 2 } },
      { value: 5, label: "必要な人にだけ先に話してみる", scores: { communicator: 2, soulowner: 1 } },
    ],
  },
  {
    id: 25,
    ...
    scores: {},
    choices: [
      { value: 1, label: "その一歩をちゃんと見ていたと伝える", scores: { movmentor: 3, soulowner: 1 } },
      { value: 2, label: "次に進みやすい小さな道を一緒に探す", scores: { movmentor: 3, revolist: 1 } },
      { value: 3, label: "続けやすい環境を整える", scores: { premiercrafter: 2, arranger: 2 } },
      { value: 4, label: "その人の動きが誰につながるか考える", scores: { communicator: 2, maxdesigner: 1 } },
      { value: 5, label: "経験を言葉にして残す", scores: { logicalmaister: 2, imagemaister: 1 } },
    ],
  },
  {
    id: 26,
    ...
    scores: {},
    choices: [
      { value: 1, label: "組み合わせて新しい体験にする", scores: { maxdesigner: 3, crazist: 1 } },
      { value: 2, label: "伝わる見た目や言葉に整える", scores: { imagemaister: 3, premiercrafter: 1 } },
      { value: 3, label: "使える情報と足りない情報を分ける", scores: { inforader: 3, logicalmaister: 1 } },
      { value: 4, label: "誰がどこを担うと進むか配置する", scores: { arranger: 3, communicator: 1 } },
      { value: 5, label: "まず小さく動かして反応を見る", scores: { revolist: 3, movmentor: 1 } },
    ],
  },
  {
    id: 27,
    text: "小さなヒントが会話の中に出ました。近い動きは？",
    scores: {},
    choices: [
      { value: 1, label: "忘れないように拾っておく", scores: { inforader: 3, premiercrafter: 1 } },
      { value: 2, label: "他の情報とつなげて見立てる", scores: { inforader: 2, logicalmaister: 2 } },
      { value: 3, label: "誰かの行動につながる形で渡す", scores: { movmentor: 2, imagemaister: 1 } },
      { value: 4, label: "場の流れを変えるきっかけにする", scores: { arranger: 2, revolist: 1 } },
      { value: 5, label: "新しい可能性の種として広げる", scores: { maxdesigner: 2, crazist: 2 } },
    ],
  },
  {
    id: 28,
    ...
    scores: {},
    choices: [
      { value: 1, label: "その想いの空気感を表す言葉を探す", scores: { imagemaister: 3, soulowner: 1 } },
      { value: 2, label: "見える形やイメージにしてみる", scores: { imagemaister: 3, maxdesigner: 1 } },
      { value: 3, label: "誰に届くと意味が生まれるか考える", scores: { communicator: 2, maxdesigner: 2 } },
      { value: 4, label: "まず伝える順番を整える", scores: { logicalmaister: 3, imagemaister: 1 } },
      { value: 5, label: "小さく出して反応を受け取る", scores: { revolist: 2, premiercrafter: 1 } },
    ],
  },
  {
    id: 29,
    ...
    scores: {},
    choices: [
      { value: 1, label: "一度呼吸できる余白", scores: { soulowner: 3, premiercrafter: 1 } },
      { value: 2, label: "今決めることと後でよいことの整理", scores: { logicalmaister: 2, arranger: 2 } },
      { value: 3, label: "みんなが参加しやすい会話の入口", scores: { communicator: 3, soulowner: 1 } },
      { value: 4, label: "まず進めるための一歩", scores: { revolist: 2, movmentor: 2 } },
      { value: 5, label: "この流れの先にある可能性", scores: { maxdesigner: 3, crazist: 1 } },
    ],
  },
  {
    id: 30,
    ...
    scores: {},
    choices: [
      { value: 1, label: "その場限りで終わらない続き方", scores: { premiercrafter: 3, arranger: 1 } },
      { value: 2, label: "関わった人がまた来たくなる安心感", scores: { soulowner: 3, premiercrafter: 1 } },
      { value: 3, label: "外に出しても信頼される仕上がり", scores: { premiercrafter: 3, inforader: 1 } },
      { value: 4, label: "次の挑戦につながる勢い", scores: { movmentor: 2, revolist: 2 } },
      { value: 5, label: "新しい人が入りやすい入口", scores: { communicator: 3, imagemaister: 1 } },
    ],
  },
  {
    id: 31,
    ...
    scores: {},
    choices: [
      { value: 1, label: "その良さを本人に言葉で返す", scores: { movmentor: 3, imagemaister: 1 } },
      { value: 2, label: "その良さが活きる場につなぐ", scores: { communicator: 2, arranger: 2 } },
      { value: 3, label: "まず安心して受け取れる空気を作る", scores: { soulowner: 3, movmentor: 1 } },
      { value: 4, label: "実際に使える小さな機会を作る", scores: { revolist: 2, movmentor: 2 } },
      { value: 5, label: "何が良さなのか整理して伝える", scores: { logicalmaister: 3, inforader: 1 } },
    ],
  },
  {
    id: 32,
    ...
    scores: {},
    choices: [
      { value: 1, label: "何を一番伝えると動きやすいか", scores: { logicalmaister: 3, movmentor: 1 } },
      { value: 2, label: "どんな順番なら誤解が少ないか", scores: { logicalmaister: 3, soulowner: 1 } },
      { value: 3, label: "どの事実が判断材料になるか", scores: { inforader: 3, logicalmaister: 1 } },
      { value: 4, label: "誰に渡すと次へ進むか", scores: { arranger: 2, communicator: 2 } },
      { value: 5, label: "どう見せると受け取りやすいか", scores: { imagemaister: 3, premiercrafter: 1 } },
    ],
  },
  {
    id: 33,
    text: "これから何かを始める人に、あなたが渡せるとしたら？",
    scores: {},
    choices: [
      { value: 1, label: "まだ見えていない未来の火種", scores: { revolist: 3, crazist: 1 } },
      { value: 2, label: "可能性が広がる設計図", scores: { maxdesigner: 3, imagemaister: 1 } },
      { value: 3, label: "人に伝わる言葉や構造", scores: { logicalmaister: 3, inforader: 1 } },
      { value: 4, label: "動ける流れと役割の配置", scores: { arranger: 3, premiercrafter: 1 } },
      { value: 5, label: "安心して続けられる関係の土台", scores: { soulowner: 3, communicator: 1 } },
    ],
  },
];

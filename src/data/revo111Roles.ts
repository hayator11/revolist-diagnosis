...
export const revo111Roles: Record<RevoTypeKey, Revo111Role> = {
  revolist: {
    ...
    mission: "まだそこにないものに気づき、形になるきっかけをつくる。",
  ...
  maxdesigner: {
    ...
    mission: "今あるものから、まだ見えていない可能性を描く。",
  ...
  communicator: {
    ...
    mission: "ご縁が動き出すきっかけをつくり、人の可能性を結びつける。",
  ...
  inforader: {
    ...
    mission: "散らばった情報を集め、次の判断に使える知恵へ変える。",
  ...
  logicalmaister: {
    ...
    mission: "散らかった話や感覚を、人が受け取りやすい形へ変える。",
  ...
  arranger: {
    ...
    mission: "バラバラな人・情報・役割をつなぎ、場が動く流れをつくる。",
  ...
  soulowner: {
    ...
    mission: "人が安心して本音を出し、挑戦を続けられる土台を育てる。",
  ...
  crazist: {
    ...
    mission: "違和感から、まだ見えていない可能性を見つける。",
